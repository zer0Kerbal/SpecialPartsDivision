...
<ul>
  <li>Thanks to Floppster for creating the initial Tweakscale configs (great work!)</li>
  <li>Thanks to Biotronic for creating Tweakscale</li>
  <li>Thanks to Snjo for letting me use his firespitter buoyancy code</li>
  <li>This plugin uses Snjo's firespitter code and Biotrnic's Tweakscale plugin</li>
